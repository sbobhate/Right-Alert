...
{
	//Wire.begin();
	//Note that here we have to specify which i2c set we are using. For our project we use i2c-0. This may change depending on which pins you use on th Jetson. For example, using pins 21 and 23 correspond to GEN1_I2C (i2c-0) while pins 18a and 20 correspond to GEN2_I2C (i2c-1) 
